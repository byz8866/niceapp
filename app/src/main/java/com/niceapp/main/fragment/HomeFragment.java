...
import com.niceapp.utils.TimeUtils;
...
public class HomeFragment extends BaseFragment {
    ...
    public void onCreated(@Nullable Bundle savedInstanceState) {
        ...
        String year = TimeUtils.getYmd_hms(TimeUtils.YEAR, true);
        String hour = TimeUtils.getYmd_hms(TimeUtils.HOUR, true);
        String hour2 = TimeUtils.getYmd_hms(TimeUtils.HOUR, false);
