...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size) throws WriterException {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size, @ColorInt int color_black, @ColorInt int color_white) throws WriterException {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int size, @Nullable Bitmap logoBitmap, float logoPercent) throws WriterException {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int size, Bitmap targetBitmap) throws WriterException {
    ...
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size,
                                            ...
                                            @Nullable Bitmap logoBitmap, float logoPercent) throws WriterException {
