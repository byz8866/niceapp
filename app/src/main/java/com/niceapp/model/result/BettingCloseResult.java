...
public class BettingCloseResult implements Parcelable {
    ...
    protected BettingCloseResult(Parcel in) {
        this.id = in.readInt();
    ...
    public static final Creator<BettingCloseResult> CREATOR = new Creator<BettingCloseResult>() {
        @Override
        public BettingCloseResult createFromParcel(Parcel source) {
            return new BettingCloseResult(source);
        }

        @Override
        public BettingCloseResult[] newArray(int size) {
            return new BettingCloseResult[size];
        }
    };
}